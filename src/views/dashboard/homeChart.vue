<template>
  <div :style="{ height: '100%', width: '100%' }" class="mapchart" />
</template>
...
export default {
  ...
  methods: {
    initChart() {
      this.chart = this.$echarts.init(this.$el, 'mapchart')
    ...
    setOptions({ categoryNames, categorySellData } = {}) {
      ...
      //   var oaption2 = { tooltip: { // 鼠标移到图里面的浮动提示框
      //     // formatter详细配置： https://echarts.baidu.com/option.html#tooltip.formatter
      //     formatter(params) {
      ...
      //     }
      //   ] }
      this.chart.setOption(oaptionsarr)
    }
  }
}
</script>

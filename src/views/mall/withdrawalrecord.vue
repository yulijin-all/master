<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.brandId" clearable size="small" class="filter-item" style="width: 200px;" placeholder="请输入品牌商家ID"/>
      <el-input v-model="listQuery.accountNo" clearable size="small" class="filter-item" style="width: 200px;" placeholder="请输入资金账号"/>
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="提现账号" prop="accountNo"/>

      <el-table-column align="center" label="品牌商户Id" prop="brandId"/>

      <el-table-column align="center" label="品牌商户名称" prop="name"/>
      ...
      <el-table-column align="center" label="操作" width="120" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['GET /admin/brokerage/approve']" v-if="scope.row.status==undefined || scope.row.status==2" type="primary" size="mini" @click="handleApprove(scope.row)">审批</el-button>
...
<script>
import { fetchList, approveTrace } from '@/api/business/withdrawalrecord'
